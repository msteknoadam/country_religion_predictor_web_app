...
export const error401 = (_req: Request, res: Response): void => {
...
export const sendOpenSourcePage = (_req: Request, res: Response): void => {
...
export const coloredConsoleLog = (text: string, color: colorTypes = "black"): void => {
